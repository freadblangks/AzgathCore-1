...
INSERT INTO `command` VALUES ('reload support', 650, 'Syntax: .reload support\r\nReload support system tables.');
INSERT INTO `command` VALUES ('reload item_random_bonus_list_template', 653, 'Syntax: .reload item_enchantment_template\nReload item_enchantment_template table.');
...
INSERT INTO `command` VALUES ('ticket bug assign', 805, 'Usage: .ticket bug assign $ticketid $gmname.\r\nAssigns the specified ticket to the specified Game Master.');
...
INSERT INTO `command` VALUES ('reload quest_locale', 667, 'Syntax: .reload quest_locale\nReload all quest_*_locale tables.');
...
INSERT INTO `command` VALUES ('ticket bug close', 806, 'Usage: .ticket bug close $ticketid.\r\nCloses the specified ticket. Does not delete permanently.');
...
INSERT INTO `command` VALUES ('reload creature_onkill_reward', 635, 'Syntax: .reload creature_onkill_reward \nReload creature_onkill_reward table.');
...
INSERT INTO `command` VALUES ('reload criteria_data', 609, 'Syntax: .reload criteria_data\nReload criteria_data table.');
...
INSERT INTO `command` VALUES ('modify currency', 775, 'Syntax: .modify currency #id #value\nAdd $amount (without precision) of $currency to the selected player.');
...
INSERT INTO `command` VALUES ('disable add criteria', 350, 'Syntax: .disable add criteria $entry $flag $comment');
...
INSERT INTO `command` VALUES ('disable remove criteria', 359, 'Syntax: .disable remove criteria $entry');
...
INSERT INTO `command` VALUES ('bnetaccount set password', 213, 'Syntax: .bnetaccount set password $account $password $password\nSet password for account.');
INSERT INTO `command` VALUES ('bnetaccount set', 212, 'Syntax: .bnetaccount set $subcommand\nType .bnetaccount set to see the list of possible subcommands or .help bnetaccount set $subcommand to see info on subcommands.');
INSERT INTO `command` VALUES ('bnetaccount password', 211, 'Syntax: .bnetaccount password $old_password $new_password $new_password\nChange your account password.');
INSERT INTO `command` VALUES ('bnetaccount create', 208, 'Syntax: .bnetaccount create $account $password\nCreate battle.net account and set password to it. Account must contain the @ symbol.');
...
INSERT INTO `command` VALUES ('movie', 873, 'Syntax: .movie');
INSERT INTO `command` VALUES ('movie play', 874, 'Syntax: .movie play id');
...
INSERT INTO `command` VALUES ('ticket bug closedlist', 807, 'Usage: Displays a list of closed bug tickets.');
INSERT INTO `command` VALUES ('ticket bug comment', 808, 'Usage: .ticket bug comment $ticketid $comment.\r\nAllows the adding or modifying of a comment to the specified ticket.');
INSERT INTO `command` VALUES ('ticket bug delete', 809, 'Usage: .ticket bug delete $ticketid.\r\nDeletes the specified ticket permanently. Ticket must be closed first.');
INSERT INTO `command` VALUES ('ticket bug list', 810, 'Usage: Displays a list of open bug tickets.');
INSERT INTO `command` VALUES ('ticket bug unassign', 811, 'Usage: .ticket bug unassign $ticketid.\r\nUnassigns the specified ticket from the current assigned Game Master.');
INSERT INTO `command` VALUES ('ticket bug view', 812, 'Usage: .ticket bug view $ticketid.\r\nReturns details about specified ticket. Ticket must be open and not deleted.');
INSERT INTO `command` VALUES ('ticket complaint assign', 813, 'Usage: .ticket complaint assign $ticketid $gmname.\r\nAssigns the specified ticket to the specified Game Master.');
INSERT INTO `command` VALUES ('ticket complaint close', 814, 'Usage: .ticket complaint close $ticketid.\r\nCloses the specified ticket. Does not delete permanently.');
INSERT INTO `command` VALUES ('ticket complaint closedlist', 815, 'Usage: Displays a list of closed complaint tickets.');
INSERT INTO `command` VALUES ('ticket complaint comment', 816, 'Usage: .ticket complaint comment $ticketid $comment.\r\nAllows the adding or modifying of a comment to the specified ticket.');
INSERT INTO `command` VALUES ('ticket complaint delete', 817, 'Usage: .ticket complaint delete $ticketid.\r\nDeletes the specified ticket permanently. Ticket must be closed first.');
INSERT INTO `command` VALUES ('ticket complaint list', 818, 'Usage: Displays a list of open complaint tickets.');
INSERT INTO `command` VALUES ('ticket complaint unassign', 819, 'Usage: .ticket complaint unassign $ticketid.\r\nUnassigns the specified ticket from the current assigned Game Master.');
INSERT INTO `command` VALUES ('ticket complaint view', 820, 'Usage: .ticket complaint view $ticketid.\r\nReturns details about specified ticket. Ticket must be open and not deleted.');
INSERT INTO `command` VALUES ('ticket suggestion assign', 821, 'Usage: .ticket suggestion assign $ticketid $gmname.Assigns the specified ticket to the specified Game Master.');
INSERT INTO `command` VALUES ('ticket suggestion close', 822, 'Usage: .ticket suggestion close $ticketid.\r\nCloses the specified ticket. Does not delete permanently.');
INSERT INTO `command` VALUES ('ticket suggestion closedlist', 823, 'Usage: Displays a list of closed suggestion tickets.');
INSERT INTO `command` VALUES ('ticket suggestion comment', 824, 'Usage: .ticket suggestion comment $ticketid $comment.\r\nAllows the adding or modifying of a comment to the specified ticket.');
INSERT INTO `command` VALUES ('ticket suggestion delete', 825, 'Usage: .ticket suggestion delete $ticketid.\r\nDeletes the specified ticket permanently. Ticket must be closed first.');
INSERT INTO `command` VALUES ('ticket suggestion list', 826, 'Usage: Displays a list of open suggestion tickets.');
INSERT INTO `command` VALUES ('ticket suggestion unassign', 827, 'Usage: .ticket suggestion unassign $ticketid.\r\nUnassigns the specified ticket from the current assigned Game Master.');
INSERT INTO `command` VALUES ('ticket suggestion view', 828, 'Usage: .ticket suggestion view $ticketid.\r\nReturns details about specified ticket. Ticket must be open and not deleted.');
INSERT INTO `command` VALUES ('ticket reset all', 829, 'Usage: Removes all closed tickets and resets the counter, if no pending open tickets exist.');
INSERT INTO `command` VALUES ('ticket reset bug', 831, 'Usage: Removes all closed bug tickets and resets the counter, if no pending open tickets exist.');
INSERT INTO `command` VALUES ('ticket reset complaint', 832, 'Usage: Removes all closed complaint tickets and resets the counter, if no pending open tickets exist.');
INSERT INTO `command` VALUES ('ticket reset suggestion', 833, 'Usage: Removes all closed suggestion tickets and resets the counter, if no pending open tickets exist.');
INSERT INTO `command` VALUES ('scene', 844, '');
INSERT INTO `command` VALUES ('scene debug', 845, 'Syntax: .scene debug\nToggle debug mode for scenes. In debug mode GM will be notified in chat when scenes start/stop/trigger event');
INSERT INTO `command` VALUES ('go quest', 834, 'Syntax: .go quest #quest_id\r\n\r\nTeleport your character to first quest poi with id #quest_id.');
...
INSERT INTO `command` VALUES ('scene play', 846, 'Syntax: .scene play #sceneId\nPlays scene with id for targeted player');
INSERT INTO `command` VALUES ('scene playpackage', 847, 'Syntax: .scene playpackage #scenePackageId #playbackFlags\nPlays scene with package id and playback flags for targeted player');
INSERT INTO `command` VALUES ('scene cancel', 848, 'Syntax: .scene cancel #scenePackageId\nCancels scene with package id for targeted player');
INSERT INTO `command` VALUES ('list scenes', 849, 'Syntax: .list scenes\nList of all active scenes for targeted character.');
INSERT INTO `command` VALUES ('reload scene_template', 850, 'Syntax: .reload scene_template\nReload scene_template table.');
INSERT INTO `command` VALUES ('bnetaccount listgameaccounts', 830, 'Syntax: .bnetaccount listgameaccounts $email $password\nLists all game accounts linked to battle.net $email');
INSERT INTO `command` VALUES ('debug conversation', 854, 'Syntax: .debug conversation $conversationId\r\nPlay given conversation.');
INSERT INTO `command` VALUES ('reload conversation_template', 853, 'Syntax: .reload conversation_template\r\nReload conversation tables.');
INSERT INTO `command` VALUES ('debug movementforce apply', 2001, 'Syntax: .debug movementforce apply #magnitude #destinationX #destinationY #destinationZ\r\nApply movement force to target');
INSERT INTO `command` VALUES ('debug movementforce', 2000, '');
INSERT INTO `command` VALUES ('debug movementforce remove', 2002, 'Syntax: .debug movementforce remove\r\nRemove movement force from target');
INSERT INTO `command` VALUES ('list quests', 2003, 'Syntax: .list quests\nList of all active quests for targeted character.');
INSERT INTO `command` VALUES ('debug send playerchoice', 869, 'Syntax: .debug send playerchoice $choiceId\r\nSend given choice to player.');
