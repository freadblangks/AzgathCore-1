...
CREATE TABLE `game_event_seasonal_questrelation`  (
  ...
  INDEX `idx_quest`(`questId`) USING BTREE
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'Player System' ROW_FORMAT = Fixed;
