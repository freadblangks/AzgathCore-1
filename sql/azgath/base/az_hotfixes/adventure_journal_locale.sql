...
CREATE TABLE `adventure_journal_locale`  (
  ...
  `ButtonText_lang` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `RewardDescription_lang` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `ContinueDescription_lang` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
