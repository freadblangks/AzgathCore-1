...
if(WITHOUT_GIT)
  set(rev_date "2021-06-12 21:08:13 +0200")
  set(rev_hash "bd4e718435cf")
  set(rev_branch "AzgathCoreBFA")
else()
  if(GIT_EXECUTABLE)
  ...
  if(NOT rev_info)
    ...
    Continuing anyway - note that the versionstring will be set to \"bd4e718435cf 2021-06-12 21:08:13 (AzgathCoreBFA)\"")
    set(rev_date "2021-06-12 21:08:13 +0200")
    set(rev_hash "bd4e718435cf")
    set(rev_branch "AzgathCoreBFA")
  else()
