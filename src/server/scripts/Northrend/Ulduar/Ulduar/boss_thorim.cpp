...
public:
    ...
    struct boss_thorimAI : public BossAI
    {
        ...
        void FinishEncounter()
        {
            ...
            me->AddUnitFlag(UnitFlags(UNIT_FLAG_RENAME));
    ...
    struct AIHelper
    {
        ...
        static uint32 GetRemainingHealOn(Unit* target)
        {
            ...
            for (AuraEffect const* aurEff : auras)
                heal += aurEff->GetAmount() * aurEff->GetTickNumber();
...
public:
    ...
    class spell_thorim_stormhammer_SpellScript : public SpellScript
    {
        ...
        void FilterTargets(std::list<WorldObject*>& targets)
        {
            targets.remove_if([](WorldObject* target) -> bool { return HeightPositionCheck(true)(target); });
