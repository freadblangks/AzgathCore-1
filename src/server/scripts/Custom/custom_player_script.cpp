...
/* AzgathCore Free Repack Welcome message */
...
public:
    ...
    void OnLogin(Player* player, bool) override
    {
        ChatHandler(player->GetSession()).SendSysMessage("|cffFF0000 This core is powered from AzgathCore team. https://discord.gg/57D59ed");
    }
};*/
