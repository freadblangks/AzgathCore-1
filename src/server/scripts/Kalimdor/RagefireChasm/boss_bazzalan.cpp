...
public:
    ...
    struct boss_bazzalanAI : public BossAI
    {
        boss_bazzalanAI(Creature* creature) : BossAI(creature, BOSS_BAZZALAN)
        {
        ...
        void Reset()
        {
            ...
            m_phase = 0;
            if (instance->GetData(BOSS_BAZZALAN) == TO_BE_DECIDED)
    ...
    {
        return GetRagefireChasmAI<boss_bazzalanAI>(creature);
    }
};
